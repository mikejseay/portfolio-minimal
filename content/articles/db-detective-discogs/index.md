...
The `<` operator here redirects the contents of the SQL script as the standard input into the Python script `psql.py`. But this syntax isn't supported in Windows PowerShell. Instead, I had to run the command like this:
